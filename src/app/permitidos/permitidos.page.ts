...
@Component({
  selector: 'app-permitidos',
  templateUrl: './permitidos.page.html',
  styleUrls: ['./permitidos.page.scss'],
})
export class PermitidosPage implements OnInit {
  ...
  grupo_alimenticio = [
    ...
    { 
      ...
      icon: 'https://firebasestorage.googleapis.com/v0/b/lifeharmony-bd5eb.appspot.com/o/bebidas.jpg?alt=media&token=9fa6d4cb-57e5-4eb3-b086-0844186caa06', 
      link:'/alimentos' 
    },
    { 
